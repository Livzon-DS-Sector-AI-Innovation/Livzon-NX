...
async def test_import_workshop_title_rows_not_mistaken_for_headers() -> None:
        ...
        [
            (
                ...
                [
                    ...
                    [3, None, "", "", "", "", "", "", "", "", "", ""],  # 仅序号
                    ["合计", None, None, 4104, None, None, None, None, None, None, None, None],
                    _SIGNATURE_ROW,
                ],
            ),
            (
                ...
                [
                    ...
                    ["合计", None, None, 501, None, None, None, None, None, None, None, None],
                    _SIGNATURE_ROW,
                ],
            ),
        ]
    ...
    assert electrical_summary.category == PurchaseRequestCategory.electrical
    assert electrical_summary.items_count == 1
    electrical_items = FakePurchaseRequestRepository.items[electrical_summary.request_id]
        ...
        [
            (
                ...
                [
                    ...
                    [None, None, None, None, None, None, None, None, None, "."],  # 占位行
                ],
            ),
            (
                "MC包材",
                [
                    ...
                    ["合计", None, None, None, None, None, None, None, None, None, None, None],
                ],
            ),
            (
                "DR包材",
        ...
        [
            ...
            (
                ...
                [
                    ...
                    ["合计", None, None, 0, None, None, None, None, None, None, None, None],
                ],
            ),
        ]
    )
        ...
        [
            ...
            (
                ...
                [
                    ...
                    ["申购部门：201二车间（霉酚酸）"],
                    _RAW_MATERIAL_HEADERS,
                    [1, 12002413, "硫酸,kg,槽车", "98%、槽车", "kg", 64000, "", "", "", ""],
                ],
            ),
            (
                "多拉化玻",
                [
                    ...
                    ["申请部门:201二车间（多拉菌素）"],
                    _ELECTRICAL_HEADERS,
                    [1, 80005889, "红水温度计,0-100℃", "0-100℃", "支", 20, 10, 200, "", "", "", ""],
                ],
            ),
        ]
    )
