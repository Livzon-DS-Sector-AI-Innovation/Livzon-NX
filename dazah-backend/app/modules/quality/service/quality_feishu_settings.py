...
DEFAULT_QUALITY_FEISHU_ENTITIES: list[tuple[str, str, str, int]] = [
    ...
    ("validation_qc_2026", "QC验证-2026年", "验证与确认", 116),
    ("validation_qc_2027", "QC验证-2027年", "验证与确认", 117),
    ("validation_qc_2028", "QC验证-2028年", "验证与确认", 118),
    ...
    # 质量检验 - 物品管理（库存/入库/出库，本地镜像 + 飞书多维表格）
    ...
    ("qc_finished_bbas_weizhisu_k6", "味之素（k6）", "成品检验", 347),
    ("qc_finished_pf", "PF", "成品检验", 348),
