...
@scheduled_tasks_router.get(
    "/scheduled-tasks/data-source-options",
...
@scheduled_tasks_router.post(
    "/scheduled-tasks/preview-card", response_model=ApiResponse, summary="预览消息卡片"
)
...
@scheduled_tasks_router.get(
    "/scheduled-tasks", response_model=ApiResponse, summary="获取定时任务列表"
)
...
@scheduled_tasks_router.post(
    "/scheduled-tasks", response_model=ApiResponse, summary="创建定时任务"
)
...
@scheduled_tasks_router.get(
    "/scheduled-tasks/{task_id}", response_model=ApiResponse, summary="获取定时任务详情"
)
...
@scheduled_tasks_router.delete(
    "/scheduled-tasks/{task_id}", response_model=ApiResponse, summary="删除定时任务"
)
