...
class ReferenceSubstance(BaseModel):
    ...
    drug_name: Mapped[str] = mapped_column(String(255), comment="药品名称")
    substance_name: Mapped[str] = mapped_column(String(255), comment="对照物质名称")
    lot_number: Mapped[str] = mapped_column(String(100), comment="批号")
    manufacturer: Mapped[str] = mapped_column(String(500), comment="生产厂家/来源")
    ...
    assay: Mapped[str | None] = mapped_column(String(50), nullable=True, comment="含量")
