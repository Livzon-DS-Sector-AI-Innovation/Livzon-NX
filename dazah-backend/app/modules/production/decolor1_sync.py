...
FIELD_MAPPING = {"陶瓷膜滤液进料体积/重量":"feed_volume","进料效价":"feed_titer","脱色活性炭/树脂型号":"carbon_type","投加量（料液比例）":"dosage","搅拌转速（rpm）":"stirring_speed","脱色温度（℃）":"decolor_temp","保温吸附时长（min）":"holding_time","终点透光率/色度":"endpoint_transmittance","脱色后料液总量":"decolor_volume","脱色前色度":"color_before","脱色后色度":"color_after","色素去除率":"color_removal_rate","重金属检测数据":"heavy_metal","蛋白杂质检测数据":"protein_impurity","透光率检测数据":"transmittance_data","活性炭残渣量":"carbon_residue","批次号":"batch_no"}
NUMBER_FIELDS = {"feed_titer","stirring_speed","decolor_temp","holding_time","color_removal_rate"}
DATE_FIELDS = {}
TABLE = "decolor1"
