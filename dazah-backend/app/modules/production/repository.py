...
class ProductionRepository:
    ...
    async def get_execution_plans(
        ...
        filters = [ProductionExecutionPlan.is_deleted.is_(False)]
        if workshop:
    ...
    async def update_process_parameter(
        ...
        query = (
            ...
            .where(
                ProcessParameter.id == param_id, ProcessParameter.is_deleted == False
            )
            .values(**data)
    ...
    async def get_records_by_batch(
        ...
        query = (
            ...
            .where(
                ...
                ProductionRecord.is_deleted == False,
            )
            .offset(skip)
            .limit(limit)
    ...
    async def update_material_balance(
        ...
        query = (
            ...
            .where(
                ...
                MaterialBalance.is_deleted == False,
            )
            .values(**data)
