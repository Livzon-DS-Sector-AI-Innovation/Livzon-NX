...
FIELD_MAPPING = {"批次":"batch_no","二次板框母液合并总量(L)":"feed_volume","真空(MPa)":"vacuum_degree","温度(℃)":"evap_temp","蒸汽压力(MPa)":"steam_pressure","浓缩终点折光(%)":"endpoint_refraction","浓缩终点比重":"endpoint_density","二次浓缩液体积(L)":"conc_volume","二次浓缩液效价(U/mL)":"conc_titer","浓缩倍数":"conc_factor","冷凝水量(L)":"condensate_volume","釜底残液(L)":"bottom_residue","挥发损耗(%)":"evap_loss_rate","浓缩收率(%)":"conc_yield","备注":"remarks"}
NUMBER_FIELDS = {"vacuum_degree","evap_temp","steam_pressure","endpoint_refraction","endpoint_density","conc_titer","conc_factor","evap_loss_rate","conc_yield"}
DATE_FIELDS = {}
TABLE = "conc2"
