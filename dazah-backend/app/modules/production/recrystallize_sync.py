...
FIELD_MAPPING = {
    "批次": "batch_no",
    "上清液总量(L)": "feed_volume",
    "上清液效价(U/mL)": "feed_titer",
    "溶剂投加量(L)": "solvent_amount",
    "纯水投加量(L)": "water_amount",
    "溶剂配比(V/V)": "solvent_ratio",
    "脱色炭/树脂投加量(%)": "carbon_dosage",
    "升温溶解温度(℃)": "dissolve_temp",
    "保温时间(min)": "holding_time",
    "降温速率(℃/h)": "cooling_rate",
    "终点结晶温度(℃)": "crystal_temp",
    "养晶时长(h)": "crystal_time",
    "结晶液色度(Hazen)": "color_hazen",
    "透光率(%)": "transmittance",
    "晶体粒度(μm)": "crystal_size",
    "母液效价(U/mL)": "mother_liquor_titer",
    "备注": "remarks",
}
NUMBER_FIELDS = {
    "feed_titer",
...
async def sync_recrystallize(
    ...
    if unmatched:
        logger.warning(
            "recrystallize 同步警告：%d 个字段未匹配：%s", len(unmatched), unmatched
        )
    return {
        "created": created,
        "updated": updated,
