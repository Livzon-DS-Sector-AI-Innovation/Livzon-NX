...
class ProductionPlan(BaseModel):
    ...
    workshop: Mapped[str | None] = mapped_column(String(64), nullable=True, comment="车间")
    product_name: Mapped[str] = mapped_column(String(128), nullable=False, comment="产品")
    plan_date: Mapped[date | None] = mapped_column(Date, nullable=True, comment="日期")
    planned_yield: Mapped[float | None] = mapped_column(Float, nullable=True, comment="计划产量")
    unit: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="单位")
    actual_completion: Mapped[float | None] = mapped_column(Float, nullable=True, comment="实际完成")
    completion_rate: Mapped[float | None] = mapped_column(Float, nullable=True, comment="完成率")
    safety_status: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="安环情况")
    quality_status: Mapped[str | None] = mapped_column(String(128), nullable=True, comment="质量情况")
    remarks: Mapped[str | None] = mapped_column(Text, nullable=True, comment="备注")
    source: Mapped[str | None] = mapped_column(String(32), default="manual", server_default="manual", nullable=True, comment="数据来源: manual / feishu")
...
class SalesPlanDetail(BaseModel):
    ...
    product_name: Mapped[str] = mapped_column(String(128), nullable=False, comment="产品名称")
    unit: Mapped[str | None] = mapped_column(String(32), nullable=True, comment="单位")
    last_month_delivered_uninvoiced: Mapped[float | None] = mapped_column(Float, nullable=True, comment="上月已发货未开票")
    current_year_delivered: Mapped[float | None] = mapped_column(Float, nullable=True, comment="当年当月发货量")
    month_planned_delivery: Mapped[float | None] = mapped_column(Float, nullable=True, comment="本月计划发货量")
    month_delivered_qty: Mapped[float | None] = mapped_column(Float, nullable=True, comment="本月已发货量")
    undelivered_qty: Mapped[float | None] = mapped_column(Float, nullable=True, comment="未发货量")
    month_planned_invoice: Mapped[float | None] = mapped_column(Float, nullable=True, comment="本月预计开票量")
    invoiced_qty: Mapped[float | None] = mapped_column(Float, nullable=True, comment="已开票量")
    delivery_completion_rate: Mapped[float | None] = mapped_column(Float, nullable=True, comment="本月发货完成率")
    last_month_end_inventory: Mapped[float | None] = mapped_column(Float, nullable=True, comment="上月底库存")
    month_planned_capacity: Mapped[float | None] = mapped_column(Float, nullable=True, comment="本月预计产能")
    month_end_inventory: Mapped[float | None] = mapped_column(Float, nullable=True, comment="本月底库存")
    remarks: Mapped[str | None] = mapped_column(Text, nullable=True, comment="备注")
    source: Mapped[str | None] = mapped_column(String(32), default="manual", server_default="manual", nullable=True, comment="数据来源")
...
from app.modules.production.fermentation_models import FermentationRecord  # noqa: F401
from app.modules.production.shift_log_models import ShiftLog  # noqa: F401
from app.modules.production.shift_handover_models import ShiftHandover  # noqa: F401
from app.modules.production.seed_culture_models import SeedCulture  # noqa: F401
from app.modules.production.nce_models import NonConformingEvent  # noqa: F401
from app.modules.production.broth_receive_models import BrothReceive  # noqa: F401
from app.modules.production.pretreatment_models import Pretreatment  # noqa: F401
from app.modules.production.ceramic_models import CeramicFeed, CeramicMembraneOps, CeramicMembraneClean, CeramicMaterialSeparation, CeramicEquipmentLog  # noqa: F401
from app.modules.production.decolor1_models import Decolor1  # noqa: F401
from app.modules.production.filter1_models import Filter1  # noqa: F401
from app.modules.production.conc1_models import Conc1  # noqa: F401
from app.modules.production.centrifuge1_models import Centrifuge1  # noqa: F401
from app.modules.production.recrystallize_models import Recrystallize  # noqa: F401
from app.modules.production.filter2_models import Filter2  # noqa: F401
from app.modules.production.conc2_models import Conc2  # noqa: F401
from app.modules.production.centrifuge2_models import Centrifuge2  # noqa: F401
from app.modules.production.dry_models import Dry  # noqa: F401
from app.modules.production.pack_models import Pack  # noqa: F401
from app.modules.production.mc_extraction_models import ExtractionRecord, ExtractionInput  # noqa: F401
from app.modules.production.mc_refinement_models import McRefinementRecord, McRefinementInput  # noqa: F401
from app.modules.production.mc_blend_models import BlendingRecord, BlendingInput  # noqa: F401
from app.modules.production.mc_qc_ba_models import QcInspection, QcInspectionItem, QcInspectionInput  # noqa: F401
from app.modules.production.mc_crude_extract_models import FermentationLiquid, RefiningBatch, SubTankRecord, SubTankSodiumStep, SubTankAcidStep  # noqa: F401
from app.modules.production.ai_analysis_models import AiAnalysis  # noqa: F401
