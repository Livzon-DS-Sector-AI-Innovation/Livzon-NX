...
FIELD_MAPPING = {"日期":"feed_date","批次号":"batch_no","进料体积(m³)":"feed_volume","进料浓度(g/L)":"feed_concentration","进料温度(°C)":"feed_temp","pH值":"ph_value","进料罐号":"tank_no","物料名称":"material_name","操作人":"operator","备注":"remarks"}
...
async def sync_ceramic_feed(config: ProductionFeishuConfig, session: AsyncSession) -> dict:
