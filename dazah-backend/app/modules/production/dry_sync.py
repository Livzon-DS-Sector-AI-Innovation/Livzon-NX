...
FIELD_MAPPING = {"批次":"batch_no","二次离心湿晶体投料重量(kg)":"feed_weight","湿品含水率(%)":"wet_moisture","烘箱温度(℃)":"oven_temp","真空度(MPa)":"vacuum_degree","干燥时长(h)":"dry_duration","热风风量(m³/h)":"air_flow","翻料间隔时间(min)":"turn_interval","终点水分(%)":"endpoint_moisture","干品总重量(kg)":"dry_weight","干品效价(U/g)":"dry_titer","干品纯度(%)":"dry_purity","烘干飞粉损耗(kg)":"powder_loss","托盘粘料残留(kg)":"tray_residue","干燥收率(%)":"dry_yield","备注":"remarks"}
NUMBER_FIELDS = {"wet_moisture","oven_temp","vacuum_degree","dry_duration","air_flow","turn_interval","endpoint_moisture","dry_titer","dry_purity","dry_yield"}
DATE_FIELDS = {}
TABLE = "dry"
