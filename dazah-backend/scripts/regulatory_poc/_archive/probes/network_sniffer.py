...
class NetworkSniffer:
    def __init__(self: Any) -> None:
        ...
        self.js_files: list[Any] = []
        self.html_content = ""

    def on_request(self: Any, request: Any) -> Any:
        url = request.url
    ...
    def on_response(self: Any, response: Any) -> Any:
        url = response.url
    ...
    def analyze(self: Any, url: Any, output_dir: Any = "/tmp") -> Any:
        print(f"\n{'=' * 70}")
        print(f"分析: {url}")
        print(f"{'=' * 70}")
        ...
        try:
            ...
            next_btn = page.query_selector(
                "a.next, .pagination .next, [class*='next'], "
            ...
            if next_btn:
                ...
                try:
                    ...
                    if after_count > before_count:
                        print(
                            f"   ✅ 翻页后新增 {after_count - before_count} 个 "
                            "API 请求!"
                        )
                    else:
                        print("   翻页后无新 API 请求")
