...
condition1 = not df_large["ligand"].str.contains("CgMe-PPh")
condition2 = not df_large["ligand"].str.contains("PPh3")
...
condition1 = df_large["ligand"].str.contains("CgMe-PPh")
condition2 = df_large["ligand"].str.contains("PPh3")
...
print("References:")
print(
    "Small scope (best yield / best cost):",
    ref_best_yield_small_scope,
    ref_best_cost_small_scope,
)
print(
    "Large scope (best yield / best cost):",
    ref_best_yield_large_scope,
    ref_best_cost_large_scope,
)
...
for round in range(0, n_rounds_small):
    EDBOplus().run(
        ...
        batch=batch_size,
        # Number of experiments in parallel that we want to perform in this round.
...
sns.scatterplot(
    ...
    y=np.array(track_results_dict["max_ei_yield"]),
    ax=ax[0][0],
    color="C1",
    s=100,
    zorder=100,
...
sns.scatterplot(
    ...
    y=track_results_dict["max_ei_cost"],
    ax=ax[0][1],
    color="C1",
    s=100,
    zorder=100,
...
sns.scatterplot(
    x=track_results_dict["n_experiments"],
    y=track_results_dict["best_yield"],
    ax=ax[1][0],
    color="C1",
    s=100,
    zorder=100,
...
sns.scatterplot(
    x=track_results_dict["n_experiments"],
    y=track_results_dict["best_cost"],
    ax=ax[1][1],
    color="C1",
    s=100,
    zorder=100,
