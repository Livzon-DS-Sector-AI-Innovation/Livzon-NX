...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_core_agent_push_template_versions_template_key",
        "agent_push_template_versions",
        ["template_key"],
        schema="core",
    )
    op.create_table(
        ...
        sa.Column(
            "channel", sa.String(length=32), server_default="feishu", nullable=False
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_core_agent_push_template_versions_template_key",
        table_name="agent_push_template_versions",
        schema="core",
    )
    op.drop_index(
        "ix_core_agent_push_template_versions_key_status",
