...
def _create_module_tables(schema: str) -> None:
    ...
    op.create_table(
        ...
        *_audit_columns(),
        ...
        sa.UniqueConstraint(
            ...
            "root_token",
            "is_deleted",
            name=f"uq_{prefix}_feishu_read_source_root",
        ),
        schema=schema,
    )
    op.create_index(
        f"ix_{prefix}_feishu_read_roots_config",
        "feishu_read_source_roots",
        ["config_id", "is_active"],
        schema=schema,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "source_path", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        ...
        *_audit_columns(),
        ...
        sa.UniqueConstraint(
            ...
            "table_id",
            "is_deleted",
            name=f"uq_{prefix}_feishu_read_resource",
        ),
        schema=schema,
    )
    op.create_index(
        f"ix_{prefix}_feishu_read_resources_root",
        "feishu_read_resources",
        ["source_root_id"],
        schema=schema,
    )
    ...
    op.create_table(
        ...
        *_audit_columns(),
        ...
        sa.UniqueConstraint(
            ...
            "field_id",
            "is_deleted",
            name=f"uq_{prefix}_feishu_read_field",
        ),
        schema=schema,
    )
    op.create_index(
        f"ix_{prefix}_feishu_read_fields_resource",
        "feishu_read_fields",
    ...
    op.create_table(
        ...
        *_audit_columns(),
        ...
        sa.UniqueConstraint(
            ...
            "record_id",
            "mirror_version",
            name=f"uq_{prefix}_feishu_read_record_version",
        ),
        schema=schema,
    )
    op.create_index(
        f"ix_{prefix}_feishu_read_records_page",
        "feishu_read_records",
    ...
    op.create_table(
        ...
        sa.Column(
            "visible_field_ids", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        *_audit_columns(),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            ...
            "resource_id",
            "is_deleted",
            name=f"uq_{prefix}_feishu_read_page_binding",
        ),
        schema=schema,
    )
    op.create_index(
        f"ix_{prefix}_feishu_read_bindings_page",
        "feishu_read_page_bindings",
        ["page_key", "sort_order"],
        schema=schema,
    )
    ...
    op.create_index(
        f"ix_{prefix}_feishu_read_runs_resource",
        "feishu_read_sync_runs",
