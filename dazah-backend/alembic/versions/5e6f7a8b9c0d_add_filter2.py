...
def upgrade():
    op.create_table(
        ...
        sa.Column("cloth_type", sa.String(64), nullable=True),
        sa.Column("cake_wet_weight", sa.String(64), nullable=True),
        sa.Column("cake_dry_weight", sa.String(64), nullable=True),
        sa.Column("crystal_purity", sa.Float(), nullable=True),
        sa.Column("crystal_titer", sa.Float(), nullable=True),
        sa.Column("filtrate_volume", sa.String(64), nullable=True),
        sa.Column("mother_liquor_titer", sa.Float(), nullable=True),
        sa.Column("wash_water", sa.String(64), nullable=True),
        sa.Column("combined_liquor", sa.String(64), nullable=True),
        sa.Column("wash_loss", sa.Float(), nullable=True),
    ...
    op.create_index(
        "ix_f2_batch", "filter2", ["batch_no"], unique=False, schema="production"
    )
    op.create_index(
        "ix_f2_frid", "filter2", ["feishu_record_id"], unique=True, schema="production"
    )
