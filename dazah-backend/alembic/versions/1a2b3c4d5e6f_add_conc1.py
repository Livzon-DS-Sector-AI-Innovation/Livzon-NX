...
def upgrade():
    op.create_table(
        ...
        sa.Column("conc_duration", sa.Float(), nullable=True),
        ...
        sa.Column("endpoint_volume", sa.String(64), nullable=True),
        sa.Column("conc_weight", sa.String(64), nullable=True),
        ...
        sa.Column("evap_loss", sa.String(64), nullable=True),
        sa.Column("wall_residue", sa.String(64), nullable=True),
    ...
    op.create_index(
        "ix_c1_batch", "conc1", ["batch_no"], unique=False, schema="production"
    )
    op.create_index(
        "ix_c1_frid", "conc1", ["feishu_record_id"], unique=True, schema="production"
    )
