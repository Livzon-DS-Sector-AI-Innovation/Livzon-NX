...
revision = '6f7a8b9c0d1e'; down_revision = '5e6f7a8b9c0d'

def upgrade():
    op.create_table('conc2',
    ...
    sa.Column('steam_pressure', sa.Float(), nullable=True), sa.Column('endpoint_refraction', sa.Float(), nullable=True),
    sa.Column('endpoint_density', sa.Float(), nullable=True), sa.Column('conc_volume', sa.String(64), nullable=True),
    sa.Column('conc_titer', sa.Float(), nullable=True), sa.Column('conc_factor', sa.Float(), nullable=True),
    sa.Column('condensate_volume', sa.String(64), nullable=True), sa.Column('bottom_residue', sa.String(64), nullable=True),
    sa.Column('evap_loss_rate', sa.Float(), nullable=True), sa.Column('conc_yield', sa.Float(), nullable=True),
    ...
    op.create_index('ix_c2_batch', 'conc2', ['batch_no'], unique=False, schema='production')
    op.create_index('ix_c2_frid', 'conc2', ['feishu_record_id'], unique=True, schema='production')
