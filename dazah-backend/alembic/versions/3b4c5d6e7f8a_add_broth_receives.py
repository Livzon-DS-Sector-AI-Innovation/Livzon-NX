...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "fermentation_batch", sa.String(128), nullable=True, comment="发酵批号"
        ),
        sa.Column(
            "received_volume", sa.String(64), nullable=True, comment="接收体积/重量"
        ),
        ...
        sa.Column(
            "mycelium_concentration", sa.Float(), nullable=True, comment="菌丝浓度"
        ),
        ...
        sa.Column(
            "sample_time", sa.DateTime(timezone=True), nullable=True, comment="取样时间"
        ),
        sa.Column(
            "inspection_result", sa.String(256), nullable=True, comment="检验结果"
        ),
