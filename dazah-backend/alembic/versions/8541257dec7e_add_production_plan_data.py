...
down_revision: str | None = "add269737689"
...
def downgrade() -> None:
    op.drop_index(
        "ix_plan_data_date", table_name="production_plan_data", schema="production"
    )
    op.drop_index(
        "ix_plan_data_product", table_name="production_plan_data", schema="production"
    )
