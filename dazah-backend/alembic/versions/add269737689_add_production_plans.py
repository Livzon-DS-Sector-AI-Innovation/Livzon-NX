...
down_revision: Union[str, None] = '3279d53f4dab'
...
def upgrade() -> None:
    ...
    sa.Column('safety_status', sa.String(length=128), nullable=True, comment='安环情况'),
    sa.Column('quality_status', sa.String(length=128), nullable=True, comment='质量情况'),
    ...
    op.create_index('ix_production_plans_product_name', 'production_plans', ['product_name'], unique=False, schema='production')
    op.create_index('ix_production_plans_plan_date', 'production_plans', ['plan_date'], unique=False, schema='production')


def downgrade() -> None:
    op.drop_index('ix_production_plans_plan_date', table_name='production_plans', schema='production')
    op.drop_index('ix_production_plans_product_name', table_name='production_plans', schema='production')
