...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            comment=(
                "状态: draft/pending_ai_analysis/pending_investigation/"
                "pending_dept_head_review/pending_cross_dept_head_review/"
                "pending_qa_review/pending_qa_head_review/"
                "pending_quality_head_review/pending_final_code/returned/"
                "closed/cancelled"
            ),
        ),
        sa.Column(
            "level", sa.String(20), nullable=True, comment="级别: minor/moderate/major"
        ),
        ...
        sa.Column(
            "investigation_records", sa.JSON(), nullable=True, comment="调查记录"
        ),
    ...
    op.create_index(
        "ix_quality_deviations_deviation_code",
        "deviations",
        ["deviation_code"],
        schema="quality",
    )
    op.create_index(
        "ix_quality_deviations_status", "deviations", ["status"], schema="quality"
    )
    op.create_index(
        "ix_quality_deviations_final_code",
        "deviations",
        ["final_code"],
        schema="quality",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default="draft",
            comment=(
                "状态: draft/submitted/under_execution/evaluation/closed/"
                "returned/cancelled"
            ),
        ),
        ...
        sa.Column(
            "root_cause_analysis", sa.Text(), nullable=True, comment="根本原因分析"
        ),
        ...
        sa.Column(
            "q_head_approver_id", sa.UUID(), nullable=True, comment="Q负责人审批人ID"
        ),
        sa.Column(
            "q_head_approval_opinion",
            sa.Text(),
            nullable=True,
            comment="Q负责人审批意见",
        ),
        ...
        sa.Column(
            "execution_status", sa.String(100), nullable=True, comment="执行状态"
        ),
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=True,
            comment="有效性评估结果: effective/ineffective",
        ),
        sa.Column("evaluation_target", sa.Text(), nullable=True, comment="评估目标"),
        sa.Column(
            "evaluation_confirmer_id", sa.UUID(), nullable=True, comment="评估确认人ID"
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_quality_capas_capa_code", "capas", ["capa_code"], schema="quality"
    )
    op.create_index("ix_quality_capas_status", "capas", ["status"], schema="quality")
    op.create_index(
        "ix_quality_capas_final_code", "capas", ["final_code"], schema="quality"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "production_head_id", sa.UUID(), nullable=True, comment="生产负责人ID"
        ),
    ...
    op.create_table(
        ...
        sa.Column("department", sa.String(100), nullable=False, comment="部门名称"),
        sa.Column(
            "week_key", sa.String(20), nullable=False, comment="周标识(如2024-W01)"
        ),
        sa.Column(
            "production_status",
            sa.String(20),
            nullable=False,
            comment="生产状态: production/stopped",
        ),
        sa.Column(
            "deviation_status",
            sa.String(50),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "department", "week_key", name="uq_dept_weekly_confirmation"
        ),
        schema="quality",
    )
    op.create_index(
        "ix_quality_dept_weekly_confirmations_department",
        "department_weekly_confirmations",
        ["department"],
        schema="quality",
    )
    op.create_index(
        "ix_quality_dept_weekly_confirmations_week_key",
        "department_weekly_confirmations",
        ["week_key"],
        schema="quality",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "review_time", sa.DateTime(timezone=True), nullable=True, comment="审核时间"
        ),
