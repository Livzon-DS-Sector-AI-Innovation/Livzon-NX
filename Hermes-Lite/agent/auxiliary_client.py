...
class _CodexCompletionsAdapter:
    ...
    def create(self, **kwargs) -> Any:
        ...
        try:
            ...
            from agent._stubs import _consume_codex_event_stream
...
def _maybe_wrap_anthropic(
    ...
    if _safe_isinstance(client_obj, CodexAuxiliaryClient):
        return client_obj
    try:
        from agent._stubs import GeminiNativeClient
        if _safe_isinstance(client_obj, GeminiNativeClient):
            return client_obj
    except ImportError:
        pass
    try:
        from agent._stubs import CopilotACPClient
    ...
    for provider_id, pconfig in PROVIDER_REGISTRY.items():
        ...
        if pool_present:
            ...
            if provider_id == "gemini":
                from agent._stubs import GeminiNativeClient, is_native_gemini_base_url
...
def _try_nous(vision: bool = False) -> Tuple[Optional[OpenAI], Optional[str]]:
    ...
    try:
        from agent._stubs import nous_rate_limit_remaining
...
def _resolve_custom_runtime() -> Tuple[Optional[str], Optional[str], Optional[str]]:
    ...
    """
    try:
        from hermes_cli._stubs import resolve_runtime_provider
...
def _try_azure_foundry(
    ...
    * Non-default ``model.base_url`` overrides are honored.
    ...
    """
    try:
        from hermes_cli._stubs import _resolve_azure_foundry_runtime
...
def _to_async_client(sync_client, model: str, is_vision: bool = False):
    ...
    try:
        from agent._stubs import GeminiNativeClient, AsyncGeminiNativeClient
    ...
    if base_url_host_matches(sync_base_url, "openrouter.ai"):
        ...
        from hermes_cli._stubs import copilot_request_headers
...
def _normalize_resolved_model(model_name: Optional[str], provider: str) -> Optional[str]:
    ...
    if not model_name:
        return model_name
    try:
        from hermes_cli._stubs import normalize_model_for_provider
...
def resolve_provider_client(
    ...
    try:
        from hermes_cli._stubs import _get_named_custom_provider
    ...
    if pconfig.auth_type == "external_process":
        ...
        try:
            from agent._stubs import has_aws_credentials, resolve_bedrock_region
...
def _main_model_supports_vision(provider: str, model: Optional[str]) -> bool:
    ...
    """
    try:
        from agent._stubs import _lookup_supports_vision
        from hermes_cli.config import load_config
    except ImportError:
        return True
    try:
