...
os.environ.setdefault("HERMES_HOME", _PROJECT_DIR)
...
class AIAgent:
    ...
    def _summarize_background_review_actions(
        ...
        from agent._stubs import summarize_background_review_actions
    ...
    def _spawn_background_review(
        ...
        keep working.
        """
        from agent._stubs import spawn_background_review_thread
    ...
    def _build_memory_write_metadata(
        ...
        *,
        ...
        from agent._stubs import build_memory_write_metadata
    ...
    def _capture_credits(self, http_response: Any) -> None:
        ...
        try:
            from agent._stubs import dev_fixture_credits_state
        ...
        try:
            from agent._stubs import parse_credits_headers
    ...
    def _emit_credits_notices(self) -> None:
        ...
        if state is None:
            return
        try:
            from agent._stubs import evaluate_credits_notices
    ...
    def _run_codex_stream(self, api_kwargs: dict, client: Any = None, on_first_delta: callable = None):
        ...
        from agent._stubs import run_codex_stream
    ...
    def _run_codex_create_stream_fallback(self, api_kwargs: dict, client: Any = None):
        ...
        from agent._stubs import run_codex_create_stream_fallback
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from hermes_cli._stubs import resolve_copilot_token
    ...
    def _run_codex_app_server_turn(
        ...
        *,
        ...
        from agent._stubs import run_codex_app_server_turn
    ...
    if list_tools:
        ...
        for name, toolset in all_toolsets.items():
            ...
            if info:
                entry = (name, info)
                # Hermes-Lite: 简化工具集分类
                if name in {"web", "memory", "session_search", "todo", "clarify"}:
