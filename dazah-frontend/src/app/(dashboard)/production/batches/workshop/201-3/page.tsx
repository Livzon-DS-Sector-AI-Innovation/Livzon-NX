...
import {
  ...
  ArrowRightOutlined, ArrowUpOutlined, ArrowDownOutlined, NodeIndexOutlined, ScheduleOutlined,
...
export default function Workshop2013Page() {
  ...
  const fetchData = useCallback(async (monthStr: string) => {
    ...
    try {
      ...
      const r = await fetch(`${API}/api/v1/production/dr/dashboard/summary?month=${monthStr}`)
  ...
  return (
    <div className="p-6">
      ...
      <Space className="mb-4" align="center" style={{ width: '100%', justifyContent: 'space-between' }}>
        ...
        <Space size={8}>
          <SyncSettingsButton productName="多拉菌素" syncTarget="production_plan" />
