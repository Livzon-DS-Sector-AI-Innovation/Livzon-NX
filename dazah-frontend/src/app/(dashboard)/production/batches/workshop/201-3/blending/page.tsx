...
const STAGES = [
  ...
  { key: 'refine2', label: '二次精制', path: '/production/batches/workshop/201-3/blending', active: true },
...
const COLUMNS: RefineColDef[] = [
  ...
  { key: 'feed_batch_no', title: '投料批次', group: null, fmt: 'text' },
  { key: 'feed_weight_kg', title: '重量(kg)', group: null, fmt: 'num' },
  { key: 'feed_pure_kg', title: '折纯(kg)', group: null, fmt: 'num' },
  { key: 'product_weight_kg', title: '二次湿粉\n重量(kg)', group: null, fmt: 'num' },
  { key: 'product_content', title: '含量', group: null, fmt: 'num' },
  { key: 'product_dry_loss', title: '干燥失重', group: null, fmt: 'num' },
  { key: 'product_pure_kg', title: '二次湿粉\n折纯(kg)', group: null, fmt: 'num' },
  { key: 'batch_yield', title: '批收率', group: null, fmt: 'num' },
  { key: 'remarks', title: '备注', group: null, fmt: 'text', remark: true },
  { key: 'recovery_powder_weight_kg', title: '复离粉\n重量(kg)', group: null, fmt: 'num' },
  { key: 'recovery_powder_pure_kg', title: '复离粉\n折纯(kg)', group: null, fmt: 'num' },
...
export default function DrSecondRefinementPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      params.set('table', 'dr_second_refinement')
      params.set('page', '1')
    ...
    <div className="p-6">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <Space size={8}>
          ...
          <DRTraceButton initialModule="second_refinement" />
        </Space>
      </div>
