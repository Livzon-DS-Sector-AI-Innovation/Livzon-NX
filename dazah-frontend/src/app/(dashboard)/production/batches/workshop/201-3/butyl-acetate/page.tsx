...
const STAGES = [
  ...
  { key: 'refine4', label: '四次精制', path: '/production/batches/workshop/201-3/butyl-acetate', active: true },
]
...
const COLUMNS: RefineColDef[] = [
  ...
  { key: 'product_weight_kg', title: '四次湿粉\n重量(kg)', group: null, fmt: 'num' },
  { key: 'product_content', title: '含量', group: null, fmt: 'num' },
  { key: 'product_dry_loss', title: '干燥失重', group: null, fmt: 'num' },
  { key: 'product_pure_kg', title: '四次湿粉\n折纯(kg)', group: null, fmt: 'num' },
  { key: 'dry_weight_kg', title: '四次干粉\n重量(kg)', group: null, fmt: 'num' },
  { key: 'yield_rate', title: '收率', group: null, fmt: 'num' },
  { key: 'impurity_6', title: '杂质6\nRRT=0.51(≤0.38)', group: null, fmt: 'num3' },
  { key: 'impurity_1', title: '杂质1\nRRT=0.59(不得检出)', group: null, fmt: 'num3' },
  { key: 'impurity_2', title: '杂质2\nRRT=0.69(≤0.75)', group: null, fmt: 'num3' },
  { key: 'impurity_7', title: '杂质7\nRRT=0.72(≤0.35)', group: null, fmt: 'num3' },
  { key: 'impurity_3', title: '杂质3\nRRT=0.88(≤0.85)', group: null, fmt: 'num3' },
  { key: 'impurity_4', title: '杂质4\nRRT=1.38(≤0.40)', group: null, fmt: 'num3' },
  { key: 'impurity_5', title: '杂质5\nRRT=1.56(≤0.35)', group: null, fmt: 'num3' },
  { key: 'rrt_083', title: 'RRT=0.83', group: null, fmt: 'num3' },
  { key: 'rrt_055', title: 'RRT=0.55', group: null, fmt: 'num3' },
  { key: 'rrt_068', title: 'RRT=0.68', group: null, fmt: 'num3' },
  { key: 'unknown_max_single', title: '未知最大单杂', group: null, fmt: 'num3' },
  { key: 'total_impurities', title: '总杂(≤4.0)', group: null, fmt: 'num3' },
  { key: 'purity', title: '纯度', group: null, fmt: 'num3' },
]

export default function DrFourthRefinementPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      params.set('table', 'dr_fourth_refinement')
      params.set('page', '1')
  ...
  useEffect(() => {
    fetch(`/api/v1/production/dr/records/years?table=dr_fourth_refinement`)
      .then(r => r.json())
    ...
    <div className="p-6">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <Space size={8}>
          ...
          <DRTraceButton initialModule="fourth_refinement" />
        </Space>
      </div>
