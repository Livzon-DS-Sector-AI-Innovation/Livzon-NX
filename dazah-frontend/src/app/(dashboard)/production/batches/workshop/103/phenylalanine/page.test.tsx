...
const RECORDS = [
  { id: 'f1', batch_no: 'FA-2603-1', product_name: 'L-苯丙氨酸', fermenter: '1#', entry_date: '2026-03-01',
...
describe('FermentationPage', () => {
  ...
  it('renders the phenylalanine fermentation list with data and plan stats', async () => {
  ...
  it('saves the monthly plan values from the plan modal', async () => {
    ...
    expect(window.localStorage.getItem('phenylalanine_plan_batches')).toBe('20')
    expect(window.localStorage.getItem('phenylalanine_plan_yield')).toBe('1500')
  })
