...
import DecolorCentrifugePage from './page'
...
describe('DecolorCentrifugePage', () => {
  let root: Root
  ...
  it('renders the decolor-centrifuge ledger with row data and avg panel', async () => {
    ...
    act(() => {
      root.render(<App><DecolorCentrifugePage /></App>)
    })
    await act(async () => {
