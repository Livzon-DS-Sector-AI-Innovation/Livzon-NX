...
describe('Decolor1Page', () => {
  ...
  it('renders the decolor1 ledger with row data and avg panel', async () => {
    const fetchMock = (url: string) => {
      if (url.includes('/fa/decolor1/list')) {
    ...
    act(() => {
      root.render(<App><Decolor1Page /></App>)
    })
    await act(async () => {
