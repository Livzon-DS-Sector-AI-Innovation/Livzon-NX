...
import MycophenolicAcidPage from './page'

const BATCHES = [
  { id: 'b1', batch_no: 'BG-2026-01', product_name: '霉酚酸', product_code: 'BG', status: 'in_progress' },
]

describe('MycophenolicAcidPage (data)', () => {
  ...
  it('renders the product data page', async () => {
    act(() => {
      root.render(<App><MycophenolicAcidPage /></App>)
    })
    await act(async () => {
