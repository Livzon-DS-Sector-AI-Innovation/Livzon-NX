...
export default async function WarehouseProductSummaryPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('产品汇总页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey='product-summary' />
}
