...
export default async function WarehouseProductOutboundLedgerPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('成品出库台账页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey='product-outbound-ledger' />
}
