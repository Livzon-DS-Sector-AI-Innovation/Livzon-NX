...
function createEmptyPageData(): WarehouseFeishuMaterialPageData {
  return {
    page_key: 'product-detail-fumaric-acid',
    page_title: '霉酚酸库存明细',
    table_name: '霉酚酸库存明细',
    columns: [],
    rows: [],
...
export default async function WarehouseProductFumaricAcidPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('霉酚酸库存明细页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey='product-detail-fumaric-acid' />
}
