...
export default async function WarehouseProductLPhenylalaninePage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('L-苯丙氨酸库存明细页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey='product-detail-l-phenylalanine' />
}
