...
export default async function WarehouseProductInboundDetailPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('成品入库明细页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey='product-inbound-detail' />
}
