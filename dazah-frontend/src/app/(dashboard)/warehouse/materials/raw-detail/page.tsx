...
export default async function WarehouseRawDetailPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('原辅料库存明细表页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey="raw-detail" />
}
