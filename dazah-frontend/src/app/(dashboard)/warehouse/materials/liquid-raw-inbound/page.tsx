...
export default async function WarehouseLiquidRawInboundPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('液体原辅料入库页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey="liquid-raw-inbound" />
}
