...
export default async function WarehouseInboundLedgerPage({ searchParams }: WarehousePageProps) {
  ...
  try {
    ...
    console.warn('入库总账页面初始数据加载失败，使用空数据降级:', error)
  }

  return <WarehouseFeishuTablePage data={data} pageKey="inbound-ledger" />
}
