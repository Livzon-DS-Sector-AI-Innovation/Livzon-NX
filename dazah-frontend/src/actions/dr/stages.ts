...
const REVALIDATE_PATH = '/production/batches/workshop/201-3'
...
export async function calculateBlendImpurities(batchNo: string) { return fetchApi<unknown>(`${BASE}/blending-records/${batchNo}/calculate`, { method: 'POST' }) }
