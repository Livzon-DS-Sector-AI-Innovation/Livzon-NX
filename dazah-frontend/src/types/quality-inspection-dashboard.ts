...
export type QualityInspectionDashboardTrendAnomaly = S['InspectionDashboardTrendAnomaly']
export type QualityInspectionDashboardTrendAISignal = S['InspectionDashboardTrendAISignal']
export type QualityInspectionDashboardTrendAIOutlook = S['InspectionDashboardTrendAIOutlook']
export type QualityInspectionDashboardTrendAI = S['InspectionDashboardTrendAI']
