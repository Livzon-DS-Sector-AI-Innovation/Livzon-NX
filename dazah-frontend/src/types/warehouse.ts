...
export type WarehouseFeishuSourceRoot =
  components['schemas']['WarehouseFeishuSourceRootResponse']
export type WarehouseFeishuSourceRootInput =
  components['schemas']['WarehouseFeishuSourceRootInput']
export type WarehouseFeishuPageBinding =
  components['schemas']['WarehouseFeishuPageBindingResponse']
export type WarehouseFeishuPageBindingInput =
  components['schemas']['WarehouseFeishuPageBindingInput']
export type WarehouseFeishuPageData =
  components['schemas']['WarehouseFeishuPageDataResponse']
export type WarehouseDataset = components['schemas']['WarehouseDatasetResponse']
export type WarehouseDatasetRecord =
  components['schemas']['WarehouseDatasetRecordResponse']
export type WarehouseAnalysisProfileInput =
  components['schemas']['WarehouseAnalysisProfileInput']
export type WarehouseAnalysisProfile =
  components['schemas']['WarehouseAnalysisProfileResponse']
export type WarehouseAnalysisRun =
  components['schemas']['WarehouseAnalysisRunResponse']
