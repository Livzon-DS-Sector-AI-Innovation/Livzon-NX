...
export type CertificateReminderTestInput = components['schemas']['CertificateReminderTestRequest']
export type CertificateReminderTestResult = components['schemas']['CertificateReminderTestResult']
