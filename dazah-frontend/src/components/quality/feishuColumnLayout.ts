...
export const feishuColumnLayouts = {
  deviationReport: ['偏差编号', '报告时间', '偏差内容', '涉及产品名称/批号', '附件', '部门', '报告人', '报告状态'],
  ...
  capaLedger: ['CAPA编号', '启动日期', '事件部门', '涉及产品', 'CAPA简述', 'CAPA效果评估', '关闭日期'],
  capaPlan: ['CAPA编号', '计划内容', '预计完成时间', '责任人', '部门', '部门负责人', '进度', '提醒状态', '关联CAPA编号'],
  oosReport: ['报告时间', '内容', '涉及产品名称', '涉及批号', '附件', '报告部门', '报告人', '部门负责人', '涉及发酵负责人', '涉及提炼负责人', 'QA', 'QA负责人'],
