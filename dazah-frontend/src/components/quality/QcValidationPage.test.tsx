...
describe('QcValidationPage', () => {
  ...
  beforeEach(() => {
    apiClient.fetchQcValidationYears.mockResolvedValue([
      { year: 2025, entity_code: 'validation_qc_2025', table_configured: false },
      { year: 2026, entity_code: 'validation_qc_2026', table_configured: true },
    ])
  ...
  it('warns when the year table is not configured', async () => {
    apiClient.fetchQcValidationYears.mockResolvedValue([
      { year: 2026, entity_code: 'validation_qc_2026', table_configured: false },
    ])
    apiClient.fetchQcValidationRecords.mockResolvedValue({
      items: [],
      total: 0,
