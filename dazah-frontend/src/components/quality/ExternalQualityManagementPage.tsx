...
export function ExternalQualityManagementPage({ initialTab }: { initialTab: ExternalQualityTab }) {
  ...
  return (
    <Space orientation="vertical" size={16} style={{ display: 'flex' }}>
      ...
      <Drawer title="新增供应商" size={520} open={supplierDrawerOpen} onClose={() => setSupplierDrawerOpen(false)} destroyOnHidden>
      ...
      <Drawer title="新增供应商资质" size={480} open={qualificationDrawerOpen} onClose={() => setQualificationDrawerOpen(false)} destroyOnHidden>
      ...
      <Drawer title="新增客户投诉" size={560} open={complaintDrawerOpen} onClose={() => setComplaintDrawerOpen(false)} destroyOnHidden>
      ...
      <Drawer title="新增退货或召回记录" size={560} open={returnRecallDrawerOpen} onClose={() => setReturnRecallDrawerOpen(false)} destroyOnHidden>
      ...
      <Drawer title="新增产品质量记录" size={560} open={productQualityDrawerOpen} onClose={() => setProductQualityDrawerOpen(false)} destroyOnHidden>
      ...
      <Drawer title="新增客户质量标准明细" size={520} open={standardItemDrawerOpen} onClose={() => setStandardItemDrawerOpen(false)} destroyOnHidden>
