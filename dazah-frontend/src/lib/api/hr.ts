...
export async function fetchEmployeeById(id: string): Promise<EmployeeResponse> {
  const res = await fetch(`/api/v1/hr/employees/${id}`, {
    cache: 'no-store',
  })
...
export async function fetchEmployeeByNumber(employeeNumber: string): Promise<EmployeeResponse> {
  const res = await fetch(`/api/v1/hr/employees/by-number/${employeeNumber}`, {
    cache: 'no-store',
  })
  if (!res.ok) throw new Error('获取员工详情失败')
  return res.json()
...
export async function fetchDepartments(
  ...
  const res = await fetch(`/api/v1/hr/departments?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchTeams(
  ...
  const res = await fetch(`/api/v1/hr/teams?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchOnboardingRecords(
  ...
  const res = await fetch(`/api/v1/hr/onboarding-records?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchDepartureRecords(
  ...
  const res = await fetch(`/api/v1/hr/departure-records?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchSyncStatus(): Promise<SyncStatusResponse> {
  const res = await fetch(`/api/v1/hr/employees/sync-status`, {
    cache: 'no-store',
  })
...
export async function syncFromFeishu(): Promise<{ code: number; message: string; data: { created: number; updated: number; failed: number; total: number } }> {
  const res = await fetch(`/api/v1/hr/employees/sync-from-feishu`, {
    method: 'POST',
    cache: 'no-store',
  })
...
export async function syncToFeishu(id: string): Promise<{ code: number; message: string; data: { feishu_record_id: string } }> {
  const res = await fetch(`/api/v1/hr/employees/${id}/sync-to-feishu`, {
    method: 'POST',
    cache: 'no-store',
  })
...
export async function syncDepartureFromFeishu(): Promise<{ code: number; message: string; data: { created: number; updated: number; failed: number; total: number } }> {
  const res = await fetch(`/api/v1/hr/departure-records/sync-from-feishu`, {
    method: 'POST',
    cache: 'no-store',
  })
...
export async function fetchOnboardingTrainingRecord(
  ...
  const res = await fetch(
    `/api/v1/hr/employees/${employeeId}/onboarding-training-record`,
    { cache: 'no-store' }
  )
...
export async function fetchPrejobTrainingPlan(
  ...
  const res = await fetch(
    `/api/v1/hr/employees/${employeeId}/prejob-training-plan`,
    { cache: 'no-store' }
  )
...
export async function generateTrainingSignInSheet(
  ...
  const res = await fetch(`/api/v1/hr/training-sign-in-sheet`, {
    method: 'POST',
...
export async function generateTrainingNotification(
  ...
  const res = await fetch(`/api/v1/hr/training-notification`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
    cache: 'no-store',
...
export async function generateOnboardingEvaluation(
  ...
  const res = await fetch(`/api/v1/hr/onboarding-evaluation`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
    cache: 'no-store',
...
export async function fetchOnboardingEvaluationByEmployeeId(
  ...
  const res = await fetch(
    `/api/v1/hr/employees/${employeeId}/onboarding-evaluation`,
    { cache: 'no-store' }
  )
  if (!res.ok) throw new Error('生成员工上岗评估表失败')
  const blob = await res.blob()
...
export async function fetchTrainingLedgers(
  ...
  const res = await fetch(`/api/v1/hr/training-ledgers?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function updateTrainingLedger(
  ...
  const res = await fetch(`/api/v1/hr/training-ledgers/${id}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify(data),
    cache: 'no-store',
...
export async function fetchTrainingLedgerPages(): Promise<{
  ...
  const res = await fetch(`/api/v1/hr/training-ledgers/pages`, {
    cache: 'no-store',
  })
...
export async function exportTrainingLedger(employeeNumber: string): Promise<void> {
  const res = await fetch(
    `/api/v1/hr/training-ledgers/export?employee_number=${encodeURIComponent(employeeNumber)}`,
    { cache: 'no-store' }
  )
...
export async function fetchNewEmployees(
  ...
  const res = await fetch(`/api/v1/hr/new/employees?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchNewDepartments(
  ...
  const res = await fetch(`/api/v1/hr/new/departments?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchNewOnboardingRecords(
  ...
  const res = await fetch(`/api/v1/hr/new/onboarding-records?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchNewDepartureRecords(
  ...
  const res = await fetch(`/api/v1/hr/new/departure-records?${searchParams.toString()}`, {
    cache: 'no-store',
  })
...
export async function fetchNewOffboardingRecords(
  ...
  const res = await fetch(`/api/v1/hr/new/offboarding-records?${searchParams.toString()}`, {
    cache: 'no-store',
  })
